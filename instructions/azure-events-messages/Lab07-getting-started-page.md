...
- Create Event Grid custom topics and endpoints  
- Build a .NET console app to send events  
- Create Event Hubs namespaces and send/receive events  
- Configure Service Bus to send and process queue messages  
- Use Azure Queue Storage to manage queue messages  

**Estimated Duration:** 2 hours (combined exercises)
